		...
		if(src.client)
			if (src.client.prisoner)
				...
				if (!IsGuestKey(src.key))
					...
					if (IsJobAvailable("Mime",mimeMax)) // oh god erika why are you doing this to me FUCK
